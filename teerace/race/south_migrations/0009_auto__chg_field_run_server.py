...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Run.server'
        db.alter_column('race_run', 'server_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['race.Server']))


    def backwards(self, orm):
        
        # Changing field 'Run.server'
        db.alter_column('race_run', 'server_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['race.Server']))

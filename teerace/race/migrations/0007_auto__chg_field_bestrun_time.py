...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('race_bestrun', 'time', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=3))


    def backwards(self, orm):
        
        # Changing field 'BestRun.time'
        db.alter_column('race_bestrun', 'time', self.gf('django.db.models.fields.FloatField')())

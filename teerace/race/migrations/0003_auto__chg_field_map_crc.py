...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Map.crc'
        db.alter_column('race_map', 'crc', self.gf('django.db.models.fields.CharField')(max_length=8, null=True))


    def backwards(self, orm):
        
        # Changing field 'Map.crc'
        db.alter_column('race_map', 'crc', self.gf('django.db.models.fields.CharField')(default='', max_length=8))

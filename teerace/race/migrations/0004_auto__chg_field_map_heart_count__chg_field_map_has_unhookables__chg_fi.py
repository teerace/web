...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Map.heart_count'
        db.alter_column('race_map', 'heart_count', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Map.has_unhookables'
        db.alter_column('race_map', 'has_unhookables', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Map.has_deathtiles'
        db.alter_column('race_map', 'has_deathtiles', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Map.shield_count'
        db.alter_column('race_map', 'shield_count', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Map.grenade_count'
        db.alter_column('race_map', 'grenade_count', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Map.heart_count'
        db.alter_column('race_map', 'heart_count', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Map.has_unhookables'
        db.alter_column('race_map', 'has_unhookables', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Map.has_deathtiles'
        db.alter_column('race_map', 'has_deathtiles', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Map.shield_count'
        db.alter_column('race_map', 'shield_count', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Map.grenade_count'
        db.alter_column('race_map', 'grenade_count', self.gf('django.db.models.fields.IntegerField')())

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BestRun.demo_file'
        db.add_column('race_bestrun', 'demo_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BestRun.demo_file'
        db.delete_column('race_bestrun', 'demo_file')

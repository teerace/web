...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Run.was_record'
        db.delete_column('race_run', 'was_record')

        # Deleting field 'Run.was_personal_best'
        db.delete_column('race_run', 'was_personal_best')

        # Deleting field 'Run.diff_from_personal_best'
        db.delete_column('race_run', 'diff_from_personal_best')

        # Deleting field 'Run.is_personal_best'
        db.delete_column('race_run', 'is_personal_best')

        # Deleting field 'Run.is_record'
        db.delete_column('race_run', 'is_record')


    def backwards(self, orm):
        
        # Adding field 'Run.was_record'
        db.add_column('race_run', 'was_record', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Run.was_personal_best'
        db.add_column('race_run', 'was_personal_best', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Run.diff_from_personal_best'
        db.add_column('race_run', 'diff_from_personal_best', self.gf('django.db.models.fields.FloatField')(default=0.0), keep_default=False)

        # Adding field 'Run.is_personal_best'
        db.add_column('race_run', 'is_personal_best', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Run.is_record'
        db.add_column('race_run', 'is_record', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

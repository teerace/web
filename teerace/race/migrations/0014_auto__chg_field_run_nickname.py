...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Run.nickname'
        db.alter_column('race_run', 'nickname', self.gf('django.db.models.fields.CharField')(max_length=15))


    def backwards(self, orm):
        
        # Changing field 'Run.nickname'
        db.alter_column('race_run', 'nickname', self.gf('django.db.models.fields.CharField')(max_length=24))

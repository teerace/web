...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.playtime'
        db.add_column('accounts_userprofile', 'playtime', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.playtime'
        db.delete_column('accounts_userprofile', 'playtime')

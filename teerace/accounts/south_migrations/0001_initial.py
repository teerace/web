...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('accounts_userprofile', (
            ...
            ('api_token', self.gf('django.db.models.fields.CharField')(unique=True, max_length=32)),
            ('registration_ip', self.gf('django.db.models.fields.IPAddressField')(max_length=15, null=True, blank=True)),
            ('last_connection_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('last_played_server', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='players', null=True, to=orm['race.Server'])),
            ('country', self.gf('django_countries.fields.CountryField')(max_length=2, blank=True)),
            ('points', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('has_skin', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('skin_name', self.gf('django.db.models.fields.CharField')(max_length=40, blank=True)),
            ('skin_body_color', self.gf('django.db.models.fields.CharField')(max_length=7, blank=True)),
            ('skin_feet_color', self.gf('django.db.models.fields.CharField')(max_length=7, blank=True)),
            ('skin_body_color_raw', self.gf('django.db.models.fields.IntegerField')(max_length=8, null=True, blank=True)),
            ('skin_feet_color_raw', self.gf('django.db.models.fields.IntegerField')(max_length=8, null=True, blank=True)),
        ))
    ...
    models = {
        ...
        'race.server': {
            ...
            'api_key': ('django.db.models.fields.CharField', [], {'default': "'NuZ8Wu2r94G2pSaVtNhqWZ8ySkjyupJY'", 'unique': 'True', 'max_length': '32'}),

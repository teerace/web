...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.api_token'
        db.alter_column('accounts_userprofile', 'api_token', self.gf('django.db.models.fields.CharField')(unique=True, max_length=24))


    def backwards(self, orm):
        
        # Changing field 'UserProfile.api_token'
        db.alter_column('accounts_userprofile', 'api_token', self.gf('django.db.models.fields.CharField')(max_length=32, unique=True))

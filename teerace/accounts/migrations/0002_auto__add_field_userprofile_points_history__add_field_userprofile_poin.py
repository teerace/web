...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.points_history'
        db.add_column('accounts_userprofile', 'points_history', self.gf('picklefield.fields.PickledObjectField')(null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'UserProfile.points_history'
        db.delete_column('accounts_userprofile', 'points_history')
    ...
    models = {
        'accounts.userprofile': {
            ...
            'points_progress': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
        ...
        'race.server': {
            ...
            'api_key': ('django.db.models.fields.CharField', [], {'default': "'YNy6rtCyMyXBQhvAHunx4gad9xURY8Ca'", 'unique': 'True', 'max_length': '32'}),
